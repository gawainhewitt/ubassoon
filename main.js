...
let one = 'ursulaLoop1';
let two = 'ursulaLoop2';
let three = 'ursulaLoop3';
let four = 'ursulaLoop4';
let five = 'ursulaLoop5';
let six = 'ursulaLoop6';

let stepName = new Array;

for(let i = 0; i < seqRows; i++){
  stepName[i] = `ursulaStep${i}`;
}
...
function welcomeScreen() {
  ...
  text( "Containing excerpts from Chowns Oak for solo bassoon performed by Ursula Leveaux.", width/10, height/10, (width/10) * 8, (height/10) * 8);
...
function startAudio() {
  ...
  Tone.Transport.scheduleRepeat(play_ = () => {player1.start();}, '4m');
  Tone.Transport.scheduleRepeat(play_ = () => {player2.start();}, '4m');
  Tone.Transport.scheduleRepeat(play_ = () => {player3.start();}, '4m');
  Tone.Transport.scheduleRepeat(play_ = () => {player4.start();}, '4m');
  Tone.Transport.scheduleRepeat(play_ = () => {player5.start();}, '4m');
  Tone.Transport.scheduleRepeat(play_ = () => {player6.start();}, '4m');
  retrieveSavedWork();
}
